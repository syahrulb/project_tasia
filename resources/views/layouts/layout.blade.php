...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="{{ url('/index') }}" class="logo">
      ...
      <span class="logo-lg"><b>Jasa</b>Persewaan</span>
    </a>
      ...
      <div class="navbar-custom-menu">
        <ul class="nav navbar-nav">
          ...
          @else          
            ...
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              <img src="{{asset('img/user-profile.png')}}" class="user-image" alt="User Image">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-footer">
                ...
                <div class="pull-right">
                  <a href="{{ route('logout') }}" href="{{ route('logout') }}" onclick="event.preventDefault(); document.getElementById('logout-form').submit();" class="btn btn-default btn-flat">Sign out</a>
    ...
    <section class="sidebar">
      ...
      <div class="user-panel">
        <div class="pull-left image">
          <img src="{{asset('img/user-profile.png')}}" class="img-circle" alt="User Image">
        </div>
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li>
            <a href="/pengaturan-akun/">
                <i class="fa fa-balance-scale"></i> <span>Akun</span>
          </a>
        </li>
        <li>
            <a href="/pengaturan-rasio/">
                <i class="fa fa-percent"></i> <span>Rasio</span>
          </a>
        </li>
          <li>
              <a href="/periode/">
...
<!-- /.content-wrapper -->
  <footer class="main-footer">
    <div class="pull-right hidden-xs">
      ...
      <strong>Copyright &copy; 2019 <a href="#">TAUBAYA</a>.</strong> All rights
    reserved.
  </footer>
  <!-- Control Sidebar -->
